			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 heading">
						...
						<h2 class="title">Service We Provide <span class="title-desc">We provide a vertical gateway to
								firms or businesses by making innovative custom software, website, and mobile
								application.</span></h2>
					</div>
				</div><!-- Title row end -->
				...
				<div class="row">
					<div class="col-md-12">
						<a href="web-delopment.html" style="color: #000;">
							<div class="col-md-4 col-sm-4 wow fadeInDown" data-wow-delay=".5s">
								<div class="service-content text-center">
									...
									<p>We help businesses by delivering robust and brainstorming web development
										solutions....</p>
								</div>
							</div>
						</a>
						<!--/ End first service -->
						<a href="mobile-app-development.html" style="color: #000;">
							<div class="col-md-4 col-sm-4 wow fadeInDown" data-wow-delay=".8s">
								<div class="service-content text-center">
									...
									<p>Providing innovative app development solutions for a better business
										experience...
									</p>
								</div>
						...
						<!--/ End Second service -->
						<a href="digital-market.html" style="color: #000;">
							<div class="col-md-4 col-sm-4 wow fadeInDown" data-wow-delay="1.1s">
								<div class="service-content text-center">
									...
									<p>We encompass all the digital marketing strategies to cover a wide range of
										marketing activities, such as social media, email, and mobile apps...</p>
								</div>
							</div>
						</a>
						<!--/ End Third service -->
				...
				<div class="row">
					<div class="col-md-12">
						<a href="design.html" style="color: #000;">
							<div class="col-md-4 col-sm-4 wow fadeInDown" data-wow-delay="1.4s">
								<div class="service-content text-center">
									...
									<h3>Design(UI/UX)</h3>
									<p>We make the product effective, interactive, and an experience you will talk
										about...</p>
								</div>
							</div>
						</a>
						<!--/ End 4th service -->
						<a href="service.html" style="color: #000;">
							<div class="col-md-4 col-sm-4 wow fadeInDown" data-wow-delay="1.7s">
								<div class="service-content text-center">
									...
									<p>Business problem evaluation of cost, integration, features, scalability and
										finally End to End product development...</p>
								</div>
							</div>
						</a>
						<!--/ End Third service -->
						<a href="testing.html" style="color: #000;">
							<div class="col-md-4 col-sm-4 wow fadeInDown" data-wow-delay="2s">
								<div class="service-content text-center">
									...
									<h3>Testing & QA</h3>
									<p>Helping businesses build a service or product through advanced testing methods in
										order to efface errors...</p>
								</div>
							</div>
						</a>
						<!--/ End 4th service -->
