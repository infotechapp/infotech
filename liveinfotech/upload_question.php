...
while ($csv_line = fgetcsv($fp, 2000)) {
    ...
    $sql = "INSERT INTO questions(question,created_at)VALUES ('".$csv_line[1]."','".$datetime."')";
    ...
    if ($conn->query($sql) === TRUE) {
    	...
    	$sql2 = "INSERT INTO answers(question_id,answers,right_answers)VALUES ('".$last_id."','".$ans."','".$csv_line[6]."')";
    	//save answers end
