                    ...
                    <div class="col-md-12" style="">
                        <form id="contact-form" action="register.php" id="saveReg" method="post" 		role="form">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                            ...
                                            name="name" id="name" placeholder="" type="text" data-validate="required"
                                            required data-message-requierd="required">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                            ...
                                            maxLength='10' name="mobile_number" id="mobile_number" placeholder=""
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-4">
							...
							<div class="row">
								...
								<div class="col-md-4">
>>>>>>> 0d3ad7c57990b7814fed4cca9fe7c84c91de85ad
								<div class="form-group">
									<label>Address</label>
