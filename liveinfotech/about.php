                        ...
                        <div class="tab-content col-md-9 col-sm-7">
                            ...
                            <div class="tab-pane animated fadeIn" id="tab_e">
                                ...
                                <p>We provide tech support services to address your issues on call. Call our Customer
                                    ...
                                    touch with you. Services for Consumers/Professionals.</p>
                            </div>
                        </div><!-- tab content -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 heading text-center">
                            <h2>Problems We`ll Help You Solve
                            </h2>
                        </div>
                    </div> <!-- Title row end -->
                    <div class="row">
                        <div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
                            <span class="feature-icon pull-left"><img src="images/services/approch.png" alt=""></span>
                            <div class="feature-content">
                                <h3>Client-centric Approach</h3>
                                <p>For any business, customers are always at the center. Being a leading web and mobile
                                    app development company, our definition goes beyond our direct customers. We always
                                    start from where you are with your ideas and we think from YOUR end customers'
                                    perspectives, their pain areas and devise a solution that solves core problems to
                        ...
                        <div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
                            <span class="feature-icon pull-left"><img src="images/services/collaboration.png"
                                    alt=""></span>
                            <div class="feature-content">
                                <h3>Effective Collaboration</h3>
                                <p>Communication is the Key. We tend to over-communicate at times. Although sounds
                                    overwhelming, but eventually it works wonders for our client business. When our
                                    development team collaborates with our clients sitting a thousand miles away, it's
                                    apparent that we stay in touch with platforms and mediums that allow effectiveness,
                        ...
                        <div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
                            <span class="feature-icon pull-left"><img src="images/services/ontime.png" alt=""></span>
                            <div class="feature-content">
                                <h3>Quality Delivered in Time</h3>
                                <p>With over two decades of experience in the offshore IT software development industry,
                                    we have a great set of internal frameworks with best-in-class infrastructure that
                                    enables us to deliver solutions with superior quality, at all times. All these
                                    years, we have learned how to prevent failures and replicate success. We don't just
                                    brag about quality. We define and deliver it in time.</p>
                            </div>
                        </div>
                        <!--/ End 3rd featurebox -->
                    </div><!-- Content row end -->
            ...
            <section id="about" class="about">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
                            <div class="feature-content">
                                <h3>UNDERSTAND CLIENTS' NEEDS</h3>
                                <p>We carefully study each customer case to understand the client’s needs and
                                    objectives, and deliver a reliable and efficient solution. We analyze all available
                                    options and provide competent advice to guide clients to informed business
                                    decisions.</p>
                            </div>
                        </div>
                        <!--/ End first featurebox -->
                        ...
                        <div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
                            ...
                            <div class="feature-content">
                                ...
                                <p>At InfoTechApp, we are committed to delivering maximum value to our clients to help
                                    them succeed in a constantly changing and challenging business world. Our
                                    fundamental corporate values stem from understanding that our success is tied to the
                        ...
                        <div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
                            ...
                            <div class="feature-content">
                                ...
                                <p>We go an extra mile to become our clients' long-term, trusted partner. Our priority
                                    is not only providing professional services and solutions, but becoming a true
                                    technology partner, dedicated to meeting client needs today and supporting clients'
                                    growing business needs tomorrow.</p>
                            </div>
                        </div>
                        <!--/ End 3rd featurebox -->
                    </div><!-- Content row end -->
            ...
            <div class="ts_counter_bg parallax parallax2">
                ...
                <div class="container">
                    <div class="row wow fadeInLeft text-center">
                        <div class="facts col-md-4 col-sm-6">
                        ...
                        <div><a href="portfolio-static.php" class="btn btn-primary solid">See Our Portfolio</a></div>
                    ...
                    <div class="row">
                        <div class="featured-tab clearfix">
                            <div class="tab-content col-md-12 col-sm-12">
                                <div class="tab-pane active animated fadeInRight" id="tab_a">
                                    <h3>Our Vision</h3>
                                    <p>Our belief in creating tangible value for our customers is what we think is
                                        different about InfoTechApp. Our attention to detail and quality is unmatched in
                                        the industry. We’re not just a resource provider. We value our customers’
                                        success as much as our own – sharing development risk, so that they can be bold
                                        in their adoption of new technologies.</p>
                                </div>
                            </div><!-- tab content -->
